...
const EditProdukScreen = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:3000/mproduk-promo/${id}`)
      ...
      .then((data) => {
        ...
        setPromo(data.promo_id?.toString() || '');
      })
  ...
  const handleModalClose = () => {
    ...
    router.replace('/manage-produk-promo'); // << pindah ke halaman manage-produk
  };

...
const TambahProdukScreen = () => {
  ...
  const handleSubmit = () => {
    ...
    const kategoriInt = parseInt(kategori_id);

    if (!nama || !deskripsi || isNaN(hargaInt) || !gambar || isNaN(kategoriInt)) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.pickerWrapper}>
        <Picker
          ...
          onValueChange={(itemValue) => setKategori_id(itemValue)}
          style={styles.picker}
